    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          ...
          >
            <svg className="w-2.5 h-2.5" fill={s.isStarred ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 20 20">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10 1l2.5 7.5H20l-6.25 4.5 2.5 7.5L10 15.5l-6.25 4.5 2.5-7.5L0 8.5h7.5L10 1z" />
            </svg>
          </button>
