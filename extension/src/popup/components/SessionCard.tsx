...
export default function SessionCard({
  s, onOpen, onToggleStar, onDelete, onDeleteTab, onReorderTabs, onReorderSessions, user
}: {
  ...
  return (
    <div 
      className={`group bg-blue-50 rounded-lg border border-blue-200 p-3 hover:shadow-md hover:scale-[1.02] transition-all duration-200 ${
    ...
    >
      <div className="flex items-center gap-3">
        {/* Scope Icon - Single square for window, multiple squares for all windows */}
        ...
        <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          ...
          >
            <svg className="w-3 h-3" fill={s.isStarred ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="w-6 h-6 rounded-md bg-blue-50 text-blue-500 hover:bg-blue-100 transition-colors flex items-center justify-center"
          >
          ...
          <button
            ...
            className="w-6 h-6 rounded-md bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors flex items-center justify-center"
            title="Show tabs"
          >
            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className="w-6 h-6 rounded-md bg-red-50 text-red-500 hover:bg-red-100 transition-colors flex items-center justify-center"
